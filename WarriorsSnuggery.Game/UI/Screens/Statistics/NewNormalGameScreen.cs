...
namespace WarriorsSnuggery.UI.Screens
{
	public class NewNormalGameScreen : Screen
	{
		...
		public NewNormalGameScreen(Game game) : base("Free Play")
		{
			...
			var hardcore = new UIText(FontManager.Default, TextOffset.RIGHT) { Position = new UIPos(-2048, 2048) };
			hardcore.SetText("Hardcore (one life): ");
			Add(hardcore);

			hardcoreInput = new CheckBox("wooden") { Position = new UIPos(1024, 2048) };
			Add(hardcoreInput);
