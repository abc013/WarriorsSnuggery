...
namespace WarriorsSnuggery.UI
{
	public class StartScreen : Screen
	{
		public StartScreen(Game game) : base("Welcome!")
		{
			...
			var warning = new TextLine(new CPos(0, 5500, 0), Font.Pixel16, TextLine.OffsetType.MIDDLE);
			...
			var move = new TextLine(new CPos(0, 3072, 0), Font.Pixel16, TextLine.OffsetType.MIDDLE);
			move.WriteText("Move: " + Color.Yellow + "W, A, S, D");
			Content.Add(move);

			var attack = new TextLine(new CPos(0, 2048, 0), Font.Pixel16, TextLine.OffsetType.MIDDLE);
			attack.WriteText("Attack: " + Color.Yellow + "Left mouse button");
			Content.Add(attack);

			var aim = new TextLine(CPos.Zero, Font.Pixel16, TextLine.OffsetType.MIDDLE);
			aim.SetText("Go up, and you'll get to the story mode. Walk down for the tutorial.");
			Content.Add(aim);

			var how = new TextLine(new CPos(0, 1024, 0), Font.Pixel16, TextLine.OffsetType.MIDDLE);
			how.SetText("");
			Content.Add(how);
